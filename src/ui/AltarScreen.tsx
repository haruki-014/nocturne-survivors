...
export default function AltarScreen({ profile, onBuy, onSelectSkin, onBack }: Props) {
  return (
    <div className="overlay dim">
      <div className="altar" role="dialog" aria-label="祭壇">
        <div className="altar-head">
          <h2 className="altar-title">祭 壇</h2>
        ...
        <p className="altar-sub">倒れた骸から集めた魂を捧げ、来たる夜に備えよ。強化は永く残る。</p>

        {/* ── 恒久強化 ── */}
        <div className="altar-section-label">恒 久 強 化</div>
          ...
          {META_UPGRADES.map((u) => {
            ...
            return (
              ...
              >
                ...
                <div className="upgrade-pips" aria-label={`段階 ${lv}/${u.max}`}>
        ...
        {/* ── 装い(スキン) ── */}
        <div className="altar-section-label">夜 の 装 い</div>
